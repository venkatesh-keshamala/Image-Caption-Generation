...
from ImageCaptioning import views as mainView
...
urlpatterns = [
    ...
    path('AdminViewCaptions/', admins.AdminViewCaptions, name='AdminViewCaptions'),

    # User Views
    path("UserRegisterActions/", usr.UserRegisterActions, name="UserRegisterActions"),
    path("UserLoginCheck/", usr.UserLoginCheck, name="UserLoginCheck"),
    path("UserHome/", usr.UserHome, name="UserHome"),
    path("UserUploadPicForm/", usr.UserUploadPicForm, name="UserUploadPicForm"),
